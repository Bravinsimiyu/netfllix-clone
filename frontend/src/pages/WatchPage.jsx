        ...
        <div className="mx-auto container px-4 py-8 h-full">
          ...
          {trailers.length > 0 && (
            <div className="flex justify-between items-center mb-4">
              <button className={` 
                bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded ${currentTrailerIndex === 0 ?
              ...
              <button className={`
                bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded ${currentTrailerIndex === trailers.length - 1 ?
                  "opacity-50 cursor-not-allowed" : ""
                } `}
          ...
          >
            ...
            <img src={ORIGINAL_IMAGE_BASE_URL + contentDetails?.poster_path} alt="Poster image"
              ...
              <div className="flex overflow-x-scroll scrollbar-hide gap-4 pb-4 group" ref={sliderRef}>
                {similarContent.map((item) => {
                  ...
                  <Link key={item.id} to={`/watch/${item.id}`}
                    className="w-52 flex-shrink-0 hover:scale-105 transition-transform duration-300"
                  >
                    <img 
